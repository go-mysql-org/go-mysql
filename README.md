...
You can see [go-mysql-elasticsearch](https://github.com/bburket/go-mysql-elasticsearch) for how to sync MySQL data into Elasticsearch. 
...
```go
import (
    "github.com/bburket/go-mysql/server"
    "net"
)
