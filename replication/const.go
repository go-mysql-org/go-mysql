...
// From Query_event_status_vars in libs/mysql/binlog/event/statement_events.h
const (
	Q_FLAGS2_CODE = iota
	Q_SQL_MODE_CODE
	Q_CATALOG_CODE
...
// SQL Modes
const (
	MODE_REAL_AS_FLOAT              uint64 = 0x1
	MODE_PIPES_AS_CONCAT            uint64 = 0x2
	MODE_ANSI_QUOTES                uint64 = 0x4
	MODE_IGNORE_SPACE               uint64 = 0x8
	MODE_NOT_USED                   uint64 = 0x10
	MODE_ONLY_FULL_GROUP_BY         uint64 = 0x20
	MODE_NO_UNSIGNED_SUBTRACTION    uint64 = 0x40
	MODE_NO_DIR_IN_CREATE           uint64 = 0x80
	MODE_ANSI                       uint64 = 0x80000
	MODE_NO_AUTO_VALUE_ON_ZERO      uint64 = 0x100000
	MODE_NO_BACKSLASH_ESCAPES       uint64 = 0x200000
	MODE_STRICT_TRANS_TABLES        uint64 = 0x400000
	MODE_STRICT_ALL_TABLES          uint64 = 0x800000
	MODE_NO_ZERO_IN_DATE            uint64 = 0x1000000
	MODE_NO_ZERO_DATE               uint64 = 0x2000000
	MODE_INVALID_DATES              uint64 = 0x4000000
	MODE_ERROR_FOR_DIVISION_BY_ZERO uint64 = 0x8000000
	MODE_TRADITIONAL                uint64 = 0x10000000
	MODE_HIGH_NOT_PRECEDENCE        uint64 = 0x40000000
	MODE_PAD_CHAR_TO_FULL_LENGTH    uint64 = 0x80000000
	MODE_TIME_TRUNCATE_FRACTIONAL   uint64 = 0x100000000
	MODE_INTERPRET_UTF8_AS_UTF8MB4  uint64 = 0x200000000
)
...
const (
	...
	OPTION_RELAXED_UNIQUE_CHECKS uint32 = 1 << 27
)
