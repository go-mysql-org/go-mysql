...
func (c *Canal) handleRowsEvent(e *replication.BinlogEvent) error {
	...
	if err != nil {
		log.Errorf("GetTable info error %v", err)
		return schema.LastGetTableInfoErr
	}
	var action string
